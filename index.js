        ...
        if (location.shortName !== "Permanently Closed") {
            if (location.state !== "" && location.countryCode === "US") {
                ...
                if (validStates.includes(location.state) === false) {
                    ...
                    fetch("http://localhost:3000/validLocations", {
                        method: "POST",
                        headers: {
                    ...
                    console.log("died tier 1")
                }
                console.log("died tier 2")
            } 
            console.log("died tier 3")
        }) 
        console.log("died tier 4")
        // validStates.sort()
        // renderStates()
        // renderLocations()
    }
